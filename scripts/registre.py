...
def render_registre_html(state: dict) -> str:
    ...
    def _seal_row(s: dict) -> str:
        ...
        return (
            f'<li class="reg-seal"><span class="reg-seq">n° {s["seq"]}</span>'
